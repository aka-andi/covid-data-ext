! function(e) {
    ...
    const i = document.querySelector(".errors"),
        ...
        a = document.querySelector(".cases"),
        u = document.querySelector(".recovered"),
        c = document.querySelector(".deaths"),
        f = document.querySelector(".result-container");
    f.style.display = "none", s.style.display = "none", i.textContent = "";
    const l = document.querySelector(".form-data"),
        p = document.querySelector(".country-name"),
        d = async e => {
            e.preventDefault(), (async e => {
                ...
                try {
                    ...
                    s.style.display = "none", a.textContent = t.data.confirmed.value, u.textContent = t.data.recovered.value, c.textContent = t.data.deaths.value, f.style.display = "block"
                } catch (e) { s.style.display = "none", f.style.display = "none", i.textContent = "We have no data for the country you have requested." }
            })(p.value), console.log(p.value)
        };
    ...
    e.exports = {
        ...
        merge: function e() {
            ...
            function r(r, n) { "object" == typeof t[n] && "object" == typeof r ? t[n] = e(t[n], r) : t[n] = r }
        ...
        deepMerge: function e() {
            ...
            function r(r, n) { "object" == typeof t[n] && "object" == typeof r ? t[n] = e(t[n], r) : t[n] = "object" == typeof r ? e({}, r) : r }
            for (var n = 0, o = arguments.length; n < o; n++) c(arguments[n], r);
            return t
        },
        extend: function(e, t, r) { return c(t, (function(t, o) { e[o] = r && "function" == typeof t ? n(t, r) : t })), e },
    ...
    (function(t) {
        ...
        u.headers = { common: { Accept: "application/json, text/plain, */*" } }, n.forEach(["delete", "get", "head"], (function(e) { u.headers[e] = {} })), n.forEach(["post", "put", "patch"], (function(e) { u.headers[e] = n.merge(i) })), e.exports = u
    }).call(this, r(16))
}, function(e, t, r) {
    "use strict";
    var n = r(1),
    ...
    e.exports = function(e) {
        return new Promise((function(t, f) {
            ...
            if (d.open(e.method.toUpperCase(), i(y, e.params, e.paramsSerializer), !0), d.timeout = e.timeout, d.onreadystatechange = function() {
                ...
                }, d.onabort = function() { d && (f(c("Request aborted", e, "ECONNABORTED", d)), d = null) }, d.onerror = function() { f(c("Network Error", e, null, d)), d = null }, d.ontimeout = function() {
            ...
            if ("setRequestHeader" in d && n.forEach(p, (function(e, t) { void 0 === l && "content-type" === t.toLowerCase() ? delete p[t] : d.setRequestHeader(t, e) })), n.isUndefined(e.withCredentials) || (d.withCredentials = !!e.withCredentials), e.responseType) try { d.responseType = e.responseType } catch (t) { if ("json" !== e.responseType) throw t }
    ...
    e.exports = function(e, t) {
        ...
        n.forEach(o, (function(e) { void 0 !== t[e] && (r[e] = t[e]) })), n.forEach(i, (function(o) { n.isObject(t[o]) ? r[o] = n.deepMerge(e[o], t[o]) : void 0 !== t[o] ? r[o] = t[o] : n.isObject(e[o]) ? r[o] = n.deepMerge(e[o]) : void 0 !== e[o] && (r[o] = e[o]) })), n.forEach(s, (function(n) { void 0 !== t[n] ? r[n] = t[n] : void 0 !== e[n] && (r[n] = e[n]) }));
        var a = o.concat(i).concat(s),
            u = Object.keys(t).filter((function(e) { return -1 === a.indexOf(e) }));
        return n.forEach(u, (function(n) { void 0 !== t[n] ? r[n] = t[n] : void 0 !== e[n] && (r[n] = e[n]) })), r
    }
}, function(e, t, r) {
    "use strict";
    ...
    var u = a(r(5));
    u.Axios = i, u.create = function(e) { return a(s(u.defaults, e)) }, u.Cancel = r(9), u.CancelToken = r(26), u.isCancel = r(4), u.all = function(e) { return Promise.all(e) }, u.spread = r(27), e.exports = u, e.exports.default = u
}, function(e, t, r) {
    "use strict";
    var n = r(1),
        o = r(3),
    ...
    u.prototype.request = function(e) {
        ...
        return r
    }, u.prototype.getUri = function(e) { return e = a(this.defaults, e), o(e.url, e.params, e.paramsSerializer).replace(/^\?/, "") }, n.forEach(["delete", "get", "head", "options"], (function(e) { u.prototype[e] = function(t, r) { return this.request(n.merge(r || {}, { method: e, url: t })) } })), n.forEach(["post", "put", "patch"], (function(e) { u.prototype[e] = function(t, r, o) { return this.request(n.merge(o || {}, { method: e, url: t, data: r })) } })), e.exports = u
}, function(e, t, r) {
    "use strict";
    var n = r(1);
    ...
    function a(e) { if (r === setTimeout) return setTimeout(e, 0); if ((r === i || !r) && setTimeout) return r = setTimeout, setTimeout(e, 0); try { return r(e, 0) } catch (t) { try { return r.call(null, e, 0) } catch (t) { return r.call(this, e, 0) } } }! function() { try { r = "function" == typeof setTimeout ? setTimeout : i } catch (e) { r = i } try { n = "function" == typeof clearTimeout ? clearTimeout : s } catch (e) { n = s } }();
    var u, c = [],
        f = !1,
        l = -1;
    ...
    "use strict";
    var n = r(7);
    e.exports = function(e, t, r) { var o = r.config.validateStatus;!o || o(r.status) ? e(r) : t(n("Request failed with status code " + r.status, r.config, null, r.request, r)) }
}, function(e, t, r) {
    "use strict";
